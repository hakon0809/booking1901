  ...
  <html>
    ...
    <body>
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                          <ul class="nav navbar-nav">
                              ...
                              <li class="active"><a href="pr_ansvarlig_konsertoversikt.php"> Konsertoversikt <span class="sr-only">(current)</span></a></li>
                          </ul>
      ...
      <main id="Main-content">
          ...
          $sql = "SELECT konsert.k_id, konsert.scene_id, konsert.k_name, konsert.k_genre, konsert.date, konsert.time_start, konsert.time_end, scene.s_name, konsert.salgstall, konsert.lenker_til_presseomtaler, konsert.mailen_til_manager
          ...
          if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<tr>
                      ...
                      <td>" . $row["time_end"]. "</td>
                      <td>" . $row["salgstall"]. "</td>
                      <td>" . $row["lenker_til_presseomtaler"]. "</td>
                      <td>" . $row["mailen_til_manager"]. "</td>
                      </tr>";
              }
              echo "</table>";
          } else {
